...
{ 
     ...
     * @return array 
     */ 
     function request($method, $endpoint, $params = array(), $access_token = null){ 
        try{ 
     ...
     */ 
     function long_lived_token(AccessToken $access_token){ 
     ...
     * @param AccessToken $access_token 
     */ 
     function set_access_token(AccessToken $access_token){ 
     ...
     * @param DateTime $time 
     */ 
     function set_expire_time(DateTime $time = null){ 
        if ($time) { 
