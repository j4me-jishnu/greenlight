...
class SubCategory extends CI_Controller 
{
    ...
    {       if(!empty($id)){
            ...
            $config['base_url'] = base_url('SubCategory/SubCategoryMenu/'.$cat_ids.'/');
            $config['total_rows'] = $this->SubCategory_model->numRows($id);
            $config['per_page'] = 8;
            ...
            $data['subcategory_page'] = $this->SubCategory_model->getSubCategoryPageTable($id,$config['per_page'],$uri_id);
