                ...
                <div class="panel-body">
                 ...
                 <?php } ?>
                  ...
                  <?php foreach($chat_msg as $chatmsg){ ?>
                    <div class="form-group" style="float: right;"><div class="col-md-12"><textarea class="form-control" id="message" name="message" rows="3" placeholder="Wirte Your Message Here" style="border-top: none;border-right: none;border-left: none;background: #e6e5e3;" disabled=""><?php echo $chatmsg->chat_from_msg; ?></textarea><br></div></div>
                  <?php } ?>
