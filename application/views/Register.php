            ...
            <div class="login-box">
              <form method="post" action="<?php echo site_url();?>/Register/reg">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      <label class="text-light-white fs-14">Referral code</label>
                      <input type="text" name="referral_code"  id="referral" class="form-control form-control-submit" placeholder="Referal code If any..">
                    </div>
                    <div class="form-group">
                      <label class="text-light-white fs-14">Email</label>
                      <input type="email" name="email"  id="email" class="form-control form-control-submit" placeholder="Email ID" onblur="emailcheck()" required>
                    </div>
                    <div class="form-group">
